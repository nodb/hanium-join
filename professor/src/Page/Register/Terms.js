...
제 1 조 (목 적)
이 약관은 '제일전기' (이하 '회사'라 합니다.)가 제공하는 서비스의 이용조건 및 절차, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
<<<<<<< HEAD
  ...
  const [isChecked, setChecked] = useState(false); //state 선언
  const history = useHistory() // 링크를 이용하지 않고 페이지 이동

  // 체크 루틴
  const handleChange = (e) => {
    setChecked(e.target.checked); //checked 한 값을 저장
  }
...
>>>>>>> 4d5aa41e408863cb259e01d3bcd237daabad38d9
  return (
    <Box>
      <Title>회원가입</Title>
      <Sub>이용 약관 동의</Sub>
