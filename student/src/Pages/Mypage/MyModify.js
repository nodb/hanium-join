...
const MyModify = (props) => {
  return (
    <Form>
      ...
      <br />
      <FormGroup row>
        <Label for="studentNumber" sm={2}>학번</Label>
        <Col sm={10}>
          <Input type="studentNumber" name="studentNumber" id="studentNumber" placeholder="학번을 입력하세요" />
        </Col>
      </FormGroup>
      <br />
      <FormGroup row>
        <Label for="exampleGrade" sm={2}>학년</Label>
        <Col sm={10}>
